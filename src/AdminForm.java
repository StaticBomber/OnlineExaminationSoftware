...
public class AdminForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelStudent.setText("Click Here for Student Login");
        ...
        jLabelStudent1.setText("Not a Admin? Click here to Sign Up");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       for(j=0;j<list.size();j++)
       {
           ...
           if(list.get(j).getemail().equals(a)&&list.get(j).getpassword().equals(b)&&list.get(j).getstatus().equals("YES"))
           {
               String m = list.get(j).getname();
               String k = list.get(j).getemail();
               email=k;
               name=m;
               Admin_Tasks rgf=new Admin_Tasks(m,k);   
               rgf.setVisible(true); 
               rgf.pack();
    ...
    private void jLabelStudentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelStudentMouseClicked
        Student_Login rgf=new Student_Login();   //create new object of the window you want to open
    ...
    private void jLabelStudent1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelStudent1MouseClicked
        Admin_SignUp rgf=new Admin_SignUp();   //create new object of the window you want to open
        rgf.setVisible(true);   //makes it visible
        rgf.pack();
        rgf.setLocationRelativeTo(null);   //sets the location relative to current  component
        rgf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
